...
[![React App CI](https://github.com/AravindaSB/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/AravindaSB/ci-cd-with-actions/actions/workflows/ci.yml)
